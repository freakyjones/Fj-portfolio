...
export default async function LogPage({ params }: LogPageProps) {
  ...
  return (
    <div className="container mx-auto max-w-3xl px-6 py-16 pb-32">
      <div className="mb-8 font-mono">
        <Link href="/logs" className="text-muted-foreground hover:text-primary transition-colors mb-6 inline-block">
          {'<--'} BACK_TO_SYSTEM_LOGS
        </Link>
